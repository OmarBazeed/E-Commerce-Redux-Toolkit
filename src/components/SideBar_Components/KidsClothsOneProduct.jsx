...
import products from '../JSON_Files/KidsCloths.json';

const KidsClothsOneProduct = () => {
          ...
          <div className='card'>
              <div className='row g-0 align-items-center'>
                  ...
                  <div className='col-sm-12 col-md-6 col-lg-8'>
                    ...
                    <p className='card-title card-price mb-2 my-3 fs-5'> Item Price : <span className="fs-5 text-primary"> {selectedProduct[0].price} $ </span></p>

                    <div className="moreDetails">
                      <p className="fs-5"> Available Pieces : <span className="text-primary fs-5">   {randomNOpieces} </span> </p>
                      <p className="fs-5"> Available Colors  <br /> <span className="text-primary fs-5">
                                      {
                                      ...
                                      return(
                                      <button className ={`btn btn-${el} me-1 mb-2`} key={Math.random()} onClick={addProductFromColorsBtn}> {el} 
                                      </button>
                                      )
                      ...
                      <button className='btn btn-outline-success mt-5' ref={btnRef}  onClick={addProductFromCartBtn}>Add To Chart </button>
                      </div>
                      </div>
                  </div>
              </div>
...
export default KidsClothsOneProduct